...
function(myquerry) {
  ...
  readRenviron(".env")
  conn = dbConnect(driver,paste("jdbc:rs:",gsub("http:","ds:",Sys.getenv("MainframeIP")),":",Sys.getenv("zDVMPort"),";DatabaseType=DVS; user=",Sys.getenv("zDVMuserID"),", password=",Sys.getenv("zDVMpassword"),sep=""), user=Sys.getenv("zDVMuserID"), password=Sys.getenv("zDVMpassword"))
